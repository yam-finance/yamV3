...
LANG=C.UTF-8 dapp test --rpc-url "https://fee7372b6e224441b747bf1fde15b2bd.eth.rpc.rivet.cloud/" -v --match test_onchain_prop_5 #test_created_proposal_4 #test_streamLifeCycle #test_kill #test_FullProp #test_LPVotingPower #test_LPVotingGov3 #test_newgov3 #test_helpers #test_rebaser #test_newgov3 #test_proposal_scenario
